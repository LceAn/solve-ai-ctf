...
KEYWORDS: dict[str, tuple[str, ...]] = {
    "web": ("http", "flask", "django", "express", "jwt", "cookie", "route", "werkzeug",
            "graphql", "minio", "template", "session", "ssrf", "ssti", "xxe", "x-forwarded",
            "content-security-policy", "saml", "oauth", "prototype pollution", "deserialization",
            "admin.php", "robots.txt", "sourcemap", "waf", "sqlmap", "blind injection"),
    "pwn": ("glibc", "libc.so", "seccomp", "malloc", "calloc", "free(", "buffer overflow",
            "tcache", "rop", "pwntools", "nc ", "one_gadget", "house of", "unsorted bin",
            "fastbin", "fsop", "ret2", "canary", "nx enabled", "got overwrite", "shellcode",
            "system(\"/bin/sh", "execve"),
    "crypto": ("rsa", "aes", "cipher", "encrypt", "decrypt", "modulus", "getprime",
               "getrandbits", "mt19937", "coppersmith", "nonce", "randrange", "seed(",
               "shuffle(", "ecb", "cbc", "gcm", "lattice", "wiener", "fermat", "pad(",
               "pkcs", "curve25519", "diffie", "handshake"),
    "reverse": ("decompile", "disassemble", "frida", "jadx", "driverentry",
                "deviceiocontrol", "ioctl", "ghidra", "angr", "correct!", "upx",
                "vmprotect", "obfusc", "z3.solve", "symbolic execution", "find_zip",
                "check_serial", "keygen"),
    "forensics": ("pcap", "ntfs", "volatility", "wireshark", "deleted file", "disk image",
                  "dns tunnel", "exif", "stegan", "binwalk", " foremost", "zsteg",
                  "stegsolve", "usb keyboard", "mft", "usn journal", "evtx", "elk"),
    "misc": ("base32", "base58", "base64", "morse", "raid", "qr", "puzzle", "riddle",
             "custom alphabet", "bacon", "brainfuck", "ook", "esolang", "regex golf",
             "cowsay"),
    "ai_security": ("prompt injection", "adversarial", "classifier", "model extraction",
                    "membership inference", "embedding", "pytorch", "tensorflow",
                    "system prompt", "jailbreak", "guardrail", "onnx", "tokenizer",
                    "few-shot", "llm", "chatbot"),
}
